# Infinite-Line Nonconvex QCQP: Alternating Refinement

**Formulation:** An infinite-line fit using the alternating anchor, direction,
and point-parameter refinement pattern from the first Python optimization
implementation.
