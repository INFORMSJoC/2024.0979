# Finite-Segment Nonconvex QCQP: Fixed Parameter Bounds

**Formulation:** A finite-segment fit whose point parameters use the fixed
interval from `fixed_parameter_lower` to `fixed_parameter_upper`.
