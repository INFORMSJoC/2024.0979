# Finite-Segment Nonconvex QCQP: Determined Lower Bound

**Version:** Original limited `correctdeterminetmin/lim222v2.jl` formulation,
cleaned as the lower-endpoint-bound variant.
...
**Line domain:** The line parameter has the configured lower bound and no upper parameter bound.
...
`coordinate_offset`, `anchor_padding`, and `parameter_lower_bound`. Keep this
version when the lower segment limit is determined during fitting and the
upper side is unrestricted.
